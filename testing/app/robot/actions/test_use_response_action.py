...
class TestUseResponseAction:
    ...
    def mock_blackboard(self):
        ...
        blackboard.set("openai_response", Mock(choices=[Mock(message=Mock(content="This is a test response"))]))
        return blackboard
    ...
    def test_execute_success(self, action, mock_blackboard):
        ...
        assert mock_blackboard.get("final_response") == "This is a test response"
